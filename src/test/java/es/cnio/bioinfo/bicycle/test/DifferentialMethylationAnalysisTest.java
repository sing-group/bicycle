...
public class DifferentialMethylationAnalysisTest {
	...
	private File controlSample1File = new File(Utils.getMethylcytosinesDirectory() + File.separator +
			"controlSample1.methylcytosines");
	private File controlSample2File = new File(Utils.getMethylcytosinesDirectory() + File.separator +
			"controlSample2.methylcytosines");
	private File treatmentSample1File = new File(Utils.getMethylcytosinesDirectory() + File.separator +
			"treatmentSample1.methylcytosines");
	private File treatmentSample2File = new File(Utils.getMethylcytosinesDirectory() + File.separator +
			"treatmentSample2.methylcytosines");
	...
	public void simpleTest() throws IOException {
		...
		Assert.assertTrue(dma.getDifferentiallyMethylatedCytosinesFile(reference, treatmentSamples, controlSamples)
				.exists());
