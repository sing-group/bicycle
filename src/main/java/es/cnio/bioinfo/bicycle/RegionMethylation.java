...
/*		sb.append("#Region\tmCG WATSON\tdepthCG WATSON\tCG WATSON methylation\tmCG CRICK\tdepthCG CRICK\tCG CRICK
methylation");
		sb.append("\tmCG total methylation\tmCG total depth\tCG TOTAL methylation");
		sb.append("\tmCHG WATSON\tdepthCHG WATSON\tCHG WATSON methylation\tmCHG CRICK\tdepthCHG CRICK\tCHG CRICK
		methylation");
		sb.append("\tmCHG total methylation\tmCHG total depth\tCHG TOTAL methylation");
		sb.append("\tmCHH WATSON\tdepthCHH WATSON\tCHH WATSON methylation\tmCHH CRICK\tdepthCHH CRICK\tCHH CRICK
		methylation");
...
*/
	...
	public String marshall() {
		...
		sb.append("\t").append(this.getmCG_WATSON()).append("\t").append(this.getCGDepth_WATSON()).append("\t").append
				(df.format(result));
		result = (double) this.getmCG_CRICK() / (double) this.getCGDepth_CRICK();
		sb.append("\t").append(this.getmCG_CRICK()).append("\t").append(this.getCGDepth_CRICK()).append("\t").append
				(df.format(result));
		result = (double) (this.getmCG_WATSON() + this.getmCG_CRICK()) / (double) (this.getCGDepth_WATSON() + this
				.getCGDepth_CRICK());
		sb.append("\t").append(this.getmCG_WATSON() + this.getmCG_CRICK()).append("\t").append(this.getCGDepth_WATSON
				() + this.getCGDepth_CRICK()).append("\t").append(df.format(result));

		//mCHG
		result = (double) this.getmCHG_WATSON() / (double) this.getCHGDepth_WATSON();
		sb.append("\t").append(this.getmCHG_WATSON()).append("\t").append(this.getCHGDepth_WATSON()).append("\t")
				.append(df.format(result));
		result = (double) this.getmCHG_CRICK() / (double) this.getCHGDepth_CRICK();
		sb.append("\t").append(this.getmCHG_CRICK()).append("\t").append(this.getCHGDepth_CRICK()).append("\t").append
				(df.format(result));
		result = (double) (this.getmCHG_WATSON() + this.getmCHG_CRICK()) / (double) (this.getCHGDepth_WATSON() + this
				.getCHGDepth_CRICK());
		sb.append("\t").append(this.getmCHG_WATSON() + this.getmCHG_CRICK()).append("\t").append(this
				.getCHGDepth_WATSON() + this.getCHGDepth_CRICK()).append("\t").append(df.format(result));


		//mCHH
		result = (double) this.getmCHH_WATSON() / (double) this.getCHHDepth_WATSON();
		sb.append("\t").append(this.getmCHH_WATSON()).append("\t").append(this.getCHHDepth_WATSON()).append("\t")
				.append(df.format(result));
		result = (double) this.getmCHH_CRICK() / (double) this.getCHHDepth_CRICK();
		sb.append("\t").append(this.getmCHH_CRICK()).append("\t").append(this.getCHHDepth_CRICK()).append("\t").append
				(df.format(result));
		result = (double) (this.getmCHH_WATSON() + this.getmCHH_CRICK()) / (double) (this.getCHHDepth_WATSON() + this
				.getCHHDepth_CRICK());
		sb.append("\t").append(this.getmCHH_WATSON() + this.getmCHH_CRICK()).append("\t").append(this
				.getCHHDepth_WATSON() + this.getCHHDepth_CRICK()).append("\t").append(df.format(result));
